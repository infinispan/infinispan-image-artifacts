...
abstract class AbstractMainTest {
   ...
   private XmlAssert infinispan() throws Exception {
      ...
      prefix2Uri.put("i", "urn:infinispan:config:13.0");
      prefix2Uri.put("cl", "urn:infinispan:config:clustered-locks:13.0");
      prefix2Uri.put("s", "urn:infinispan:server:13.0");
      prefix2Uri.put("j", "urn:org:jgroups");
      prefix2Uri.put("ce", "urn:infinispan:config:cloudevents:13.0");
